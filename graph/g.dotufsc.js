 ...
 **
 \*/
        ...
        var kx = (width - paddingleft - gutter) / ((maxx - minx) || 1),
            ky = (height - paddingbottom - gutter * 2) / ((maxy - miny) || 1);
        ...
        for (var i = 0, ii = valuesy.length; i < ii; i++) {
            var X = x + paddingleft + gutter + (valuesx[i] - minx) * kx,
                Y = y + height - paddingbottom - gutter - (valuesy[i] - miny) * ky;
