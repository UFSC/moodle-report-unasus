 ...
 * @throws Exception
 */
function loop_atividades_e_foruns_sintese2($query_atividades, $query_forum, $query_quiz, $query_lti, $loop = null,
    ...
    if ((is_null($loop) && $report->get_relatorio() == 'atividades_nota_atribuida') ||
        ...
        $loop = loop_atividades_e_foruns_sintese2($query_atividades, $query_forum, $query_quiz, $query_lti, true);
