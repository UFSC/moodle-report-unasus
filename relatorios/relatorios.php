 ...
 * TCC:
 *
 * Relatorio entrega de atividades
 */
 ...
 * TCC:
 *
 * Relatorio de atividades concluídas
 */
 ...
 * TCC:
 *
 * Relatorio de TCCs Consolidados
 */

function get_table_header_tcc_consolidado() {
    $header = get_table_header_tcc_portfolio_entrega_atividades(true);
...
function get_dados_tcc_consolidado() {
    /* Factory */
    $factory = Factory::singleton();
