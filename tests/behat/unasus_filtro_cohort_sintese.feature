...
Feature: Filtro de cohort e grupo nos relatórios UNA-SUS de síntese da tutoria
  # O Background e' o mesmo de unasus_filtro_cohort_estudantes.feature: a feature foi dividida em duas para o
