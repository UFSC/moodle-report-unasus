...
Feature: Relatórios UNA-SUS: acesso de manager em relatórios de orientação TCC
  Para acompanhar orientação TCC de forma consolidada
  Como usuário manager com report/unasus:view_all
  Preciso visualizar todos os grupos e todos os estudantes nos relatórios de orientação TCC
