 ...
 */
final class unasus_escopo_vazio_test extends \advanced_testcase {
    /** @var context_course */
    protected $context;
     ...
     */
    public function test_tutoria_null_nao_e_vazio(): void {
     ...
     */
    public function test_tutoria_lista_vazia_e_vazio(): void {
        $this->usuario_com(['report/unasus:view_tutoria']);
     ...
     */
    public function test_tutoria_um_grupo_nao_e_vazio(): void {
        $this->usuario_com(['report/unasus:view_tutoria']);
     ...
     */
    public function test_tutoria_varios_grupos_nao_e_vazio(): void {
        $this->usuario_com(['report/unasus:view_tutoria']);
     ...
     */
    public function test_orientacao_null_nao_e_vazio(): void {
     ...
     */
    public function test_orientacao_lista_vazia_e_vazio(): void {
        $this->usuario_com(['report/unasus:view_orientacao']);
     ...
     */
    public function test_orientacao_um_grupo_nao_e_vazio(): void {
        $this->usuario_com(['report/unasus:view_orientacao']);
     ...
     */
    public function test_orientacao_varios_grupos_nao_e_vazio(): void {
        $this->usuario_com(['report/unasus:view_orientacao']);
     ...
     */
    public function test_view_all_nunca_e_vazio(): void {
     ...
     */
    public function test_sem_capability_do_eixo_nao_e_vazio(): void {
        $this->usuario_com([]);
        $this->assertFalse(report_unasus_escopo_vazio('boletim', $this->context, [], []));
        $this->assertFalse(report_unasus_escopo_vazio('tcc_consolidado', $this->context, [], []));
    }
     ...
     */
    public function test_relatorio_restrito_nao_e_vazio(): void {
     ...
     */
    public function test_cantos_relatorio_de_tutoria(): void {
        $this->usuario_com(['report/unasus:view_tutoria', 'report/unasus:view_orientacao']);
     ...
     */
    public function test_cantos_relatorio_de_orientacao(): void {
        $this->usuario_com(['report/unasus:view_tutoria', 'report/unasus:view_orientacao']);
