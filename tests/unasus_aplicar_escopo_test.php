 ...
 */
final class unasus_aplicar_escopo_test extends \advanced_testcase {
    /** @var context_course */
    protected $context;
    /** @var int */
     ...
     */
    public function test_tutoria_de_0_a_3_grupos(): void {
     ...
     */
    public function test_orientacao_de_0_a_3_grupos(): void {
        foreach ([0, 1, 2, 3] as $n) {
     ...
     */
    public function test_filtro_forjado_e_substituido(): void {
     ...
     */
    public function test_view_all_mantem_o_filtro(): void {
     ...
     */
    public function test_sem_capability_nao_muda_nada(): void {
        $this->usuario([], 1, 1);
        $report = $this->report();
        report_unasus_aplicar_escopo_do_papel($report);
