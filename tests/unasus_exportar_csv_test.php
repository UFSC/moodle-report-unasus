...
final class unasus_exportar_csv_test extends \advanced_testcase {
     ...
     */
    public function test_grafico_controle_sem_escopo_traz_os_3_grupos(): void {
        $this->usuario(['report/unasus:view_tutoria'], [$this->grupos[0]]);
     ...
     * @covers ::report_unasus_dados_grafico
     */
    public function test_grafico_tutor_em_1_de_3_grupos_traz_1(): void {
        $this->usuario(['report/unasus:view_tutoria'], [$this->grupos[0]]);
        $report = $this->report(null, 'atividades_vs_notas');
     ...
     * @covers ::report_unasus_dados_grafico
     */
    public function test_grafico_filtro_forjado_nao_amplia_o_escopo(): void {
        $this->usuario(['report/unasus:view_tutoria'], [$this->grupos[0]]);
     ...
     * @covers ::report_unasus_dados_grafico
     */
    public function test_grafico_view_all_traz_os_3_grupos(): void {
        $this->usuario(['report/unasus:view_all', 'report/unasus:view_tutoria'], []);
        $report = $this->report(null, 'atividades_vs_notas');
     ...
     * @covers ::report_unasus_dados_grafico
     */
    public function test_grafico_tutor_sem_grupo_nao_traz_dados(): void {
        $this->usuario(['report/unasus:view_tutoria'], []);
        $report = $this->report(null, 'atividades_vs_notas');
